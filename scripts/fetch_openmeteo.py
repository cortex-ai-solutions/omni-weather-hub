...
def _parse_response(data: dict) -> list[dict]:
    ...
    for i, ts in enumerate(times):
        ...
        records.append({
            ...
            "humidity": _int_val(hourly, "relative_humidity_2m", i),
            "precipitation": _val(hourly, "precipitation", i),
            "wind_speed": _val(hourly, "wind_speed_10m", i),
            "wind_direction": _int_val(hourly, "wind_direction_10m", i),
            "wind_gust": _val(hourly, "wind_gusts_10m", i),
            "solar_radiation": _val(hourly, "shortwave_radiation", i),
            "uv_index": uv,
            "apparent_temperature": _val(hourly, "apparent_temperature", i),
            "dew_point": _val(hourly, "dew_point_2m", i),
